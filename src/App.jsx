...
export default function App() {
  ...
  return (
    <div style={{fontFamily:F,background:"#FFFFFF",minHeight:"100vh",color:"#111827",maxWidth:480,margin:"0 auto"}}>
      ...
      {/* ─── HERO BANNER ─── */}
      <div style={{background:curGym.grad,padding:"22px 22px 18px",borderRadius:"0 0 28px 28px",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{display:"flex",padding:"10px 20px 0",gap:0}}>
        {[{id:"gym",l:"🏋️ Gym"},{id:"log",l:"📝 Log"},{id:"contacts",l:"👥 People"},{id:"stats",l:"📊 Stats"}].map(function(t) {
